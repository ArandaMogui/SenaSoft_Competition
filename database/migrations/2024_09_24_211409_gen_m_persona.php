...
return new class extends Migration
{
    ...
    {
        Schema::create('gen_m_persona', function (Blueprint $table) {
            $table->engine = "InnoDB";
            ...
            $table->timestamps();
            $table->foreign('id_tipoid')->references('id')->on('gen_p_lista_opcion')->onDelete("cascade");
            $table->foreign('id_sexobiologico')->references('id')->on('gen_p_lista_opcion')->onDelete("cascade");
        });
    }
